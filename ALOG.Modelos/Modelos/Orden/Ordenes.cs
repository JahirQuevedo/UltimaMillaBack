...
{
    public class Ordenes : IActivable
    {
        [Key]
        ...
        public ICollection<SLOPeticionesReferencias> SLOpeticionesReferencias { get; set; }
        public ICollection<SLOIntegracionReferencia> SLOintegracionReferencias { get; set; }
        public virtual ICollection<SLOIntegraFacturaEnc> SLOintegracionFacturaEnc { get; set; } = new List<SLOIntegraFacturaEnc>();
        public ICollection<DtAcarreos> dtAcarreos { get; set; }
        public ICollection<DtUltimaMillaEnc> dtUltimaMillaEnc { get; set; }
        public ICollection<SLOSolicitudes> SLOSolicitudes { get; set; }
