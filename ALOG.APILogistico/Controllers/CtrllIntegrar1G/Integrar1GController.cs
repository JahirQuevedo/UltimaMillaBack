    ...
    public class Integrar1GController : Controller
    {
        ...
        public async Task<IActionResult> IntAticiposSolCrear([FromBody] IntegraAnticipoSol entidad)
        {
            try
            {
                ...
                _ctintegraAnticiposSol.AgregarGenerico(entidad);
                return Ok(entidad);
            }
            catch (Exception ex)
            {
        ...
        {
            var entidadExistente = _ctintegraAnticiposSol.obtenerPorIdGenerico(id);
            ...
            _ctintegraAnticiposSol.ActualizarGenerico(id, entidad);
        ...
        {
            var lista = await _ctintegraAnticiposSol.obtenerListaTodosGenerico();
            return Ok(lista);
        }
        ...
        {
            var entidad = _ctintegraAnticiposSol.obtenerPorIdGenerico(id);
        ...
        {
            bool resultado = _ctintegraAnticiposSol.AltaGenerico(id, x => x.GetType().GetProperty("Activo"), true);
        ...
        {
            bool resultado = _ctintegraAnticiposSol.BajaGenerico(id, x => x.GetType().GetProperty("Activo"), false);
        ...
        public async Task<IActionResult> integraReferenciaCrear([FromBody] IntegraReferencia entidad)
        {
            try
            {
                ...
                _ctintegraReferencia.AgregarGenerico(entidad);
                return Ok(entidad);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost("CrearReferenciaFacturacion")]
        public async Task<IActionResult> CrearReferenciaFacturacion([FromBody] List<int> ordenes) {
            try {
                await _ctintegraReferencia.CrearReferenciasFacturacion(ordenes);
            } catch (Exception ex) {
                return StatusCode(500, $"Error interno del servidor: {ex.Message}");
            }
            return Ok();
        ...
        {
            var entidadExistente = _ctintegraReferencia.obtenerPorIdGenerico(id);
            ...
            _ctintegraReferencia.ActualizarGenerico(id, entidad);
        ...
        {
            var lista = await _ctintegraReferencia.obtenerListaTodosGenerico();
            return Ok(lista);
        }
        ...
        {
            var entidad = _ctintegraReferencia.obtenerPorIdGenerico(id);
        ...
        {
            bool resultado = _ctintegraReferencia.AltaGenerico(id, x => x.GetType().GetProperty("Activo"), true);
        ...
        {
            bool resultado = _ctintegraReferencia.BajaGenerico(id, x => x.GetType().GetProperty("Activo"), false);
